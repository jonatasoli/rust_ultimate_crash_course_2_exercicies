...
//
//! A pumpkin is a cultivar of winter squash that is round with smooth, slightly
...
//! for cultivars of Cucurbita pepo, but some cultivars of Cucurbita maxima,
//! C. argyrosperma, and C. moschata with similar appearance are also
...
/// # Recipes
///
///  Recipes will most assureadly be coming very, very soon!
pub struct Pumpkin {
